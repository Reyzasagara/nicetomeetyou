...
function renderReadingPanel() {
    ...
    if (typeof WORD_FIRST_DATA !== "undefined") {
        WORD_FIRST_DATA.forEach(lvl => {
            ...
            if (lvl.level === 1)  html += `<h3 class="wr-section-header">🔤 Step 1 — Learn Through Words</h3>`;
            ...
            html += `<div class="rw-category-card ${!isUnlocked ? 'wr-locked-card' : ''} ${isComplete ? 'wr-complete-card' : ''}">
